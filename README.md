...
Лёгкая веб-панель для работы с [Green API](https://green-api.com) (WhatsApp): авторизация по instance и token, ввод номера собеседника и чат с отправкой и получением сообщений.
